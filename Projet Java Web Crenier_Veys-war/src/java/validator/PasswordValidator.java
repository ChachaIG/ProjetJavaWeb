...
public class PasswordValidator implements Validator {
    ...
    public void verifSamePassword(String mdp, String mdp2){
        if(!mdp.equals(mdp2)){
            FacesMessage mess = new FacesMessage("Les mots de passe ne correspondent pas");
            throw new ValidatorException(mess);
        }   
        else{
            // Rechercher dans la BD si l'adresse mail existe
            // if (yes) ==> Error
